<div class="footer-wrap">
	...
	<footer id="about" class="wrapper clearfix">
		...
		<section class="connect">
			...
			<img class="logo" title="Smallery" alt="Smallery" src="img/logo.svg">
...
<script src="js/vendor/lightboxme.js"></script>
<script src="js/vendor/scrollto.js"></script>

<script src="glyphs/ss-gizmo/ss-gizmo.js"></script>
<script src="glyphs/ss-social/ss-social.js"></script>
